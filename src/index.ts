...
const scrollEffectsPlugin: any = plugin.withOptions<ScrollEffectsConfig>(
  (options = {}) => {
    return ({ addUtilities, addBase, matchUtilities, theme, addVariant }) => {
      ...
      matchUtilities(
        {
          'scroll-parallax-y': (value: string) => ({
            '--tw-scroll-parallax-y': value,
            'will-change': 'transform',
          }),
          'scroll-parallax-x': (value: string) => ({
            '--tw-scroll-parallax-x': value,
            'will-change': 'transform',
          }),
          'scroll-parallax-z': (value: string) => ({
      ...
      matchUtilities(
        {
          'scroll-parallax-scale': (value: string) => ({
      ...
      matchUtilities(
        {
          'scroll-parallax-rotate': (value: string) => ({
            '--tw-scroll-parallax-rotate': value,
            'will-change': 'transform',
          }),
          'scroll-parallax-rotate-x': (value: string) => ({
            '--tw-scroll-parallax-rotate-x': value,
            'will-change': 'transform',
          }),
          'scroll-parallax-rotate-y': (value: string) => ({
      ...
      matchUtilities(
        {
          'scroll-speed': (value: string) => ({
            '--tw-scroll-speed': value,
          }),
          'scroll-range-start': (value: string) => ({
            '--tw-scroll-range-start': value,
          }),
          'scroll-range-end': (value: string) => ({
